...
- When the game ends, text appears telling which player won
...
### Added
- [[^]](https://github.com/XVNexus/brutalsky/issues/6) Ingame changelog (UI elements are generated by scanning a markdown file from a github url)
### Changed
...
### Fixed
- [[^]](https://github.com/XVNexus/brutalsky/issues/7) Reduced player friction so they don't stick when they on top of each other anymore
...
### Fixed
- Random compile error that I have no clue where it came from (I legit fixed it by changing the github changelog URL to a testing URL and then undoing the change)

## *V 0.17.2 // Discontinued (currently rewriting game) &nbsp; `2021-10-14 08:17`*
### Added
- FPS meter
- Game pauses when any menus are opened
### Fixed
- Edited v0.13, v0.15, v0.17, and v0.17.1 changelog entries
